  ...
  render() {
    return (
      <div>
        <div className="container">
          <div className="row mt-3 mb-3 col-md-12 ">
            ...
            <div className="offset-md-5">
              <button
                style={{ backgroundColor: "#092b51d1", cursor: "pointer" }}
                onClick={this.getPreviousPosts}
          ...
          {this.state.isLoading ? (
            ...
            <div className="row">
              <div className="col-sm-10">
                <PostList
                  posts={this.state.trending ? this.state.trending.posts : null}
                  columns={3}
                />
              </div>
                    ...
                    <div className="row">
                      <div className="col-lg-12">
                        <ul className="list-unstyled mb-0">
                          {this.state.topTenTags
                            ? this.state.topTenTags.tags.map((tag) => {
                                return (
                                  <li key={tag.ID}>
                                    <br />
                                    <span
                                      onClick={() =>
                                        this.getPostsByTag(tag.slug)
                                      }
                                      className="tagBtn"
                                    >
        ...
        {!this.state.isLoading ? (
          <footer className="py-5  mt-2 bg-dark fixed-footer">
            <div className="container">
